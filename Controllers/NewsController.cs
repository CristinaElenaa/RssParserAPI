...
namespace RssParser.Controllers
{
    ...
    public class NewsController : ControllerBase
    {
        ...
        [HttpGet("defaultUrl")]
        public async Task<ActionResult<List<RssItem>>> GetAllNewsFromDefaultUrl()
        {
            var items = _newsService.GetNews(_url);
            return Ok(items);
        }
        ...
        [HttpPost]
        public async Task<ActionResult<List<News>>> SaveNewsListToDb(string url)
        {
            var newsItems = _newsService.GetNews(url);
